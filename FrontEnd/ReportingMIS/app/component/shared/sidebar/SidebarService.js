(function () {
    ...
    SidebarService.$inject = ['$http', '$cookieStore', '$rootScope', '$timeout', 'AppSettings'];
    function SidebarService($http, $cookieStore, $rootScope, $timeout, AppSettings) {
        var service = {};
        ...
        function GetMenuData(username, callback) {
            ...
            /* Use this for real authentication
             ----------------------------------------------*/
            $http.get(AppSettings.baseUrl + '/Security/GetSideMenus/' + username)
