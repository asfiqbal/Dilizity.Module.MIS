...
(function () {
    ...
    function dilizityBackofficeMakerController($scope, $stateParams, $rootScope, AuthenticationService, dilizityBackofficeMakerService, UniversalService, Notification) {
        ...
        (function initController() {
            console.log("dilizityBackofficeMakerController.initController -> Begin");

            permissionId = $stateParams.permissionId;
            console.log("permissionId", permissionId);

            loadScreenPermissionsAndInfo();
            console.log("dilizityBackofficeMakerController.initController -> End");
        })();
        ...
        function deleteMakerActivities() {
            ...
            dilizityBackofficeMakerService.Delete(deletePermission, tmpUserName, vm.selectedMakerActivities,
                function (response) {
                    console.log("Success!");
