...
(function () {
    ...
    checkerController.$inject = ['$scope', '$stateParams', '$rootScope', 'AuthenticationService', 'UniversalService', 'Notification'];
    function checkerController($scope, $stateParams, $rootScope, AuthenticationService, UniversalService, Notification) {
        var vm = this;
        ...
        (function initController() {
            console.log("checkerController.initController -> Begin");

            permissionId = $stateParams.permissionId;
            console.log("permissionId", permissionId);

            loadScreenPermissionsAndInfo();
            console.log("checkerController.initController -> End");
        })();
