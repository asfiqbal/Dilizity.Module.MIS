            ...
            columnDefs:[ 
              ...
              { name: 'Action', cellTemplate: '<div>'+
                                                '<ul class="nav navbar-right panel_toolbox">'+
	                                                '<li>'+
                                                		'<a ng-show="grid.appScope.vm.userPermission.View===\'Dilizity.Backoffice.User.View\'" uib-tooltip="View Role" tooltip-placement="left" ui-sref="index.ActionRole({ userId: row.entity.UserId, makerId: 0, permissionName: \'Dilizity.Backoffice.User.View\' })" class="pull-right"><i class="fa fa-eye"></i></a>' +
	                                                '</li>'+
	                                                '<li>'+
		                                                '<a ng-show="grid.appScope.vm.userPermission.Edit===\'Dilizity.Backoffice.User.Edit\'" uib-tooltip="Edit Role" tooltip-placement="left" ui-sref="index.ActionRole({ userId: row.entity.UserId, makerId: 0, permissionName: \'Dilizity.Backoffice.User.Edit\' })" class="pull-right"><i class="fa fa-pencil-square"></i></a>' +
		                                                '<a ng-show="grid.appScope.vm.userPermission.Edit===\'Dilizity.Backoffice.User.Edit.Maker\'" uib-tooltip="Edit Role [Maker]" tooltip-placement="left" ui-sref="index.ActionRole({ userId: row.entity.UserId, makerId: 0, permissionName: \'Dilizity.Backoffice.User.Edit.Maker\' })" class="pull-right"><i class="fa fa-pencil-square"></i></a>' +
	                                                '<li>' +
	                                                '<li>' +
		                                                '<a ng-show="grid.appScope.vm.userPermission.Delete===\'Dilizity.Backoffice.User.Delete\'" uib-tooltip="Delete Role" tooltip-placement="left" ui-sref="index.ActionRole({ userId: row.entity.UserId, makerId: 0, permissionName: \'Dilizity.Backoffice.User.Delete\' })" class="pull-right"><i class="fa fa-trash"></i></a>' +
		                                                '<a ng-show="grid.appScope.vm.userPermission.Delete===\'Dilizity.Backoffice.User.Delete.Maker\'" uib-tooltip="Delete Role [Maker]" tooltip-placement="left" ui-sref="index.ActionRole({ userId: row.entity.UserId, makerId: 0, permissionName: \'Dilizity.Backoffice.User.Delete.Maker\' })" class="pull-right"><i class="fa fa-trash"></i></a>' +
	                                                '<li>' +
                                                '</ul>' +
                                               '</div>' }
            ],
