...
namespace Dilizity.API.Security.Managers
{
    ...
    public class PasswordPolicySearchBusinessManager : IAbstractBusiness
    {
        private const string SEARCH_PASSWORD_POLICY = "SearchPasswordPolicy";
        ...
        public void Do(BusService parameterBusService)
        {
            using (FnTraceWrap tracer = new FnTraceWrap())
            {
                ...
                try
                {
                    ...
                    {
                        outList = dataLayer.ExecuteUsingKey(SEARCH_PASSWORD_POLICY, "Id", Id, "Name", Name, "PageSize", pageSize, "PageNumber", pageNumber, "SortOrder", sortOrder, "SortDirection", sortDirection);
